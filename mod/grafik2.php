...
include"koneksi.php";
    ...
    if($id == ""){
        ...
        while($d = mysql_fetch_array($c)){
            ...
            $s0 = mysql_query("select count(*) as jml from tbl_informasi where jenis = '$d[id]' ") or die(mysql_error());
            }else{
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: '<?php echo "<h2>Grafik Sebaran </h2>"; ?>'

        },
        subtitle: {
            text: '<?php echo"Kategori $tt[kategori]";?>'
        },
        xAxis: {
